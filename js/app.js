...
const HOSPITALS = [
  {
    ...
    equipment: [
      { name: '3DEEP', image: '장비 소개 이미지/healhouse-gangnam/01.jpg', treatmentTags: ['안티에이징'] },
      { name: 'alltite05', image: '장비 소개 이미지/healhouse-gangnam/02.jpg', treatmentTags: ['안티에이징'] },
      { name: '더마샤인', image: '장비 소개 이미지/healhouse-gangnam/03.jpg', treatmentTags: ['안티에이징'] },
      { name: '미라젯', image: '장비 소개 이미지/healhouse-gangnam/04.jpg', treatmentTags: ['안티에이징'] },
      { name: '버츄', image: '장비 소개 이미지/healhouse-gangnam/05.jpg', treatmentTags: ['안티에이징'] },
      { name: '슈링크유니버스', image: '장비 소개 이미지/healhouse-gangnam/06.jpg', treatmentTags: ['안티에이징'] },
      { name: '써마지', image: '장비 소개 이미지/healhouse-gangnam/07.jpg', treatmentTags: ['안티에이징'] },
      { name: '울쎄라', image: '장비 소개 이미지/healhouse-gangnam/08.jpg', treatmentTags: ['안티에이징'] },
      { name: '인터오션-고압산소', image: '장비 소개 이미지/healhouse-gangnam/09.jpg', treatmentTags: ['안티에이징'] },
      { name: '쥬브젠', image: '장비 소개 이미지/healhouse-gangnam/10.jpg', treatmentTags: ['안티에이징'] },
      { name: '텐써마 01', image: '장비 소개 이미지/healhouse-gangnam/11.jpg', treatmentTags: ['안티에이징'] },
      { name: '티타늄', image: '장비 소개 이미지/healhouse-gangnam/12.jpg', treatmentTags: ['안티에이징'] },
      { name: '피아모', image: '장비 소개 이미지/healhouse-gangnam/13.jpg', treatmentTags: ['안티에이징'] },
      { name: 'CO2', image: '장비 소개 이미지/healhouse-gangnam/14.jpg', treatmentTags: ['레이저'] },
      { name: 'GV', image: '장비 소개 이미지/healhouse-gangnam/15.jpg', treatmentTags: ['레이저'] },
      { name: 'M22', image: '장비 소개 이미지/healhouse-gangnam/16.jpg', treatmentTags: ['레이저'] },
      { name: '레블라이트', image: '장비 소개 이미지/healhouse-gangnam/17.jpg', treatmentTags: ['레이저'] },
      { name: '로터스3', image: '장비 소개 이미지/healhouse-gangnam/18.jpg', treatmentTags: ['레이저'] },
      { name: '브이빔', image: '장비 소개 이미지/healhouse-gangnam/19.jpg', treatmentTags: ['레이저'] },
      { name: '울트라펄스 앙코르', image: '장비 소개 이미지/healhouse-gangnam/20.jpg', treatmentTags: ['레이저'] },
      { name: '인라이튼 루비피코', image: '장비 소개 이미지/healhouse-gangnam/21.jpg', treatmentTags: ['레이저'] },
      { name: '젠틀맥스프로', image: '장비 소개 이미지/healhouse-gangnam/22.jpg', treatmentTags: ['레이저'] },
      { name: '포토나스타워커', image: '장비 소개 이미지/healhouse-gangnam/23.jpg', treatmentTags: ['레이저'] },
      { name: '헬리오스Ⅳ', image: '장비 소개 이미지/healhouse-gangnam/24.jpg', treatmentTags: ['레이저'] },
      { name: 'FN광선(UV700)', image: '장비 소개 이미지/healhouse-gangnam/25.jpg', treatmentTags: ['치료기'] },
      { name: 'HF광선(UV400NB)', image: '장비 소개 이미지/healhouse-gangnam/26.jpg', treatmentTags: ['치료기'] },
      { name: '손발광선기', image: '장비 소개 이미지/healhouse-gangnam/27.jpg', treatmentTags: ['치료기'] },
      { name: '얼굴광선기', image: '장비 소개 이미지/healhouse-gangnam/28.jpg', treatmentTags: ['치료기'] },
      { name: '엑시머 EXL-440', image: '장비 소개 이미지/healhouse-gangnam/29.jpg', treatmentTags: ['치료기'] },
      { name: '전신광선기', image: '장비 소개 이미지/healhouse-gangnam/30.jpg', treatmentTags: ['치료기'] },
      { name: '전신광선기2', image: '장비 소개 이미지/healhouse-gangnam/31.jpg', treatmentTags: ['치료기'] }
    ]
  },
  {
    id: 'human-pyeongtaek',
