...
const TREATMENT_GROUPS = [
  {
    ...
    items: ['여드름', '모공', '백반증', '백반증수술', '엑시머레이저', '팔라스레이저', '광선치료', '자외선치료', '백반증탈색치료', '켈로이드', '내향성발톱', '내향성발톱수술', '선천성모반', '선천성멜라닌세포성모반', '난치성모반', '베커모반', '밀크반점', '군집성흑자증', '주름', '탈모메조테라피', '외상흉터', '홍조/주사', '수술흉터', '화상흉터', '자해흔', '시술 및 수술부작용·합병증', '외상', '화상', '찰과상', '다한증치료', '조직검사', '탈모', '남성형탈모시술', '피부외과적수술', '피부질환', '아토피피부염', '아토피', '두드러기', '건선', '옴', '한포진', '원형탈모', '사마귀', '티눈', '아토피 광선치료', '피부장벽치료', '피부장벽', '민감성피부', '주사피부염']
  },
  {
    id: 'laser',
    name: '레이저',
    icon: 'fa-bolt',
    items: ['레이저토닝', '기미/색소', '흉터', '여드름흉터', '여성제모', '여성특수제모', '문신제거', '쿠션흉터', '울트라펄스 알파', '흉터레이저', '색소침착', '색소', '색소레이저', '미라드라이', '남성특수부위토닝', '여성특수부위토닝', '여드름 주사', '혈관 레이저']
  },
  {
    id: 'lifting',
    name: '리프팅',
    icon: 'fa-arrow-up-from-bracket',
    items: ['리프팅', '탄력', '써마지', '덴서티알파', '울쎄라', '울쎄라피프라임', '올타이트', '티타늄', '소프웨이브', '텐써마', '더블타이트', '슈링크', '인모드', '세르프', '브이로', '바디온다', '온다', '타이트닝', '덴서티', '피부항노화치료', '벨루티']
  },
  {
    id: 'aesthetic',
    name: '피부시술',
    icon: 'fa-syringe',
    items: ['쁘띠성형', '필러', '스킨부스터', '스컬트라', '실리프팅', '힐로웨이브', '쥬베룩', '쥬브젠', '줄기세포', 'MCT', 'PRP', '메조보톡스', '항노화', '피부결', '레디어스', '리바이브', '스킨보톡스', '스킨보툴리늄톡신', '얼굴윤곽', '더엘주사', '리쥬란', '스킨바이브', '고우리', '약물전달치료', '큐어젯', '스킨젯', '트리필 프로', '이미지가이드 필러', '이미지가이드 보톡스', '리투오', '쥬베룩볼륨', '쥬브아셀', '보톡스', '흉터시술', '리제네라', '미용수술']
  },
  {
    id: 'other',
    name: '기타',
