...
const MEMBERS = [
  ...
  },
  {
    ...
    treatments: ['색소 레이저', '여드름 주사', '혈관 레이저', '흉터 레이저', '밸루티', '백반증', '건선', '아토피 광선치료', '사마귀', '티눈', '화상·찰과상'],
    links: []
  },
  {
    id: 'kang-seunghee',
  ...
  },
  {
    ...
    lectures: [],
    awards: [],
    treatments: ['울쎄라', '써마지', '세르프', '슈링크', '인모드', '브이로', '여성특수부위토닝', '기미/색소', '필러', '여드름', '제모', '조직검사', '한포진', '각종피부질환'],
    links: []
  },
  {
    id: 'ha-jeongmin',
  ...
  },
  {
    ...
    awards: ['2023 우수기획자상'],
    treatments: ['수술흉터', '외상흉터', '화상흉터', '여드름흉터', '시술 및 수술부작용·합병증', '자해흔', '선천성모반', '색소침착', '피부항노화치료', '리프팅', '타이트닝', '체형교정', '미용수술', '피부질환진료', '피부외과적수술', '외상', '화상'],
    links: []
  },
  {
    id: 'jeon-sooyoung',
    ...
    lectures: [],
    awards: [],
    treatments: ['색소침착', '피부질환진료', '여드름', '탈모', '비만'],
    links: []
  },
  {
    id: 'lee-solam',
...
const TREATMENT_GROUPS = [
  {
    ...
    items: ['여드름', '모공', '백반증', '백반증수술', '엑시머레이저', '팔라스레이저', '광선치료', '자외선치료', '백반증탈색치료', '켈로이드', '내향성발톱', '내향성발톱수술', '선천성모반', '선천성멜라닌세포성모반', '난치성모반', '베커모반', '밀크반점', '군집성흑자증', '주름', '탈모메조테라피', '외상흉터', '홍조/주사']
  },
  {
    id: 'laser',
    name: '레이저',
    icon: 'fa-bolt',
    items: ['레이저토닝', '기미/색소', '흉터', '여드름흉터', '여성제모', '여성특수제모', '문신제거', '쿠션흉터', '울트라펄스 알파']
  },
  {
    id: 'lifting',
    name: '리프팅',
    icon: 'fa-arrow-up-from-bracket',
    items: ['리프팅', '탄력', '써마지', '덴서티알파', '울쎄라', '울쎄라피프라임', '올타이트', '티타늄', '소프웨이브', '텐써마', '더블타이트']
  },
  {
    id: 'aesthetic',
    name: '피부시술',
    icon: 'fa-syringe',
    items: ['쁘띠성형', '필러', '스킨부스터', '스컬트라', '실리프팅', '힐로웨이브', '쥬베룩', '쥬브젠', '줄기세포', 'MCT', 'PRP', '메조보톡스', '항노화', '피부결', '레디어스', '리바이브', '스킨보톡스', '스킨보툴리늄톡신', '얼굴윤곽', '더엘주사', '리쥬란', '스킨바이브', '고우리', '약물전달치료', '큐어젯', '스킨젯', '트리필 프로', '이미지가이드 필러', '이미지가이드 보톡스']
  },
  {
    id: 'other',
    name: '기타',
