...
const TREATMENT_GROUPS = [
  {
    ...
    name: '피부질환',
    icon: 'fa-stethoscope',
    items: ['여드름', '모공', '백반증', '백반증수술', '엑시머레이저', '팔라스레이저', '광선치료', '자외선치료', '백반증탈색치료', '건선', '아토피', '사마귀', '무좀', '탈모', '피부암', '켈로이드', '내향성발톱', '선천성모반', '주름', '탈모메조테라피']
  },
  {
    id: 'laser',
    name: '레이저',
    icon: 'fa-bolt',
    items: ['레이저토닝', '기미/색소', '흉터', '여드름흉터', '점', '여성제모', '문신제거']
  },
  {
    id: 'lifting',
    name: '리프팅',
    icon: 'fa-arrow-up-from-bracket',
    items: ['리프팅', '탄력', '써마지', '울쎄라', '올타이트', '티타늄', '소프웨이브', '텐써마']
  },
  {
    id: 'aesthetic',
    name: '피부시술',
    icon: 'fa-syringe',
    items: ['쁘띠성형', '필러', '스킨부스터', '스컬트라', '실리프팅', '힐로웨이브', '쥬베룩', '쥬브젠', '줄기세포', 'MCT', 'PRP', '메조보톡스', '항노화', '피부결', '레디어스', '리바이브', '스킨보톡스', '얼굴윤곽', '더엘주사']
  },
  {
    id: 'other',
    name: '기타',
    icon: 'fa-ellipsis',
    items: ['고압산소', '비만', '다이어트', '체형교정']
  }
];
